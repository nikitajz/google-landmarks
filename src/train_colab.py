...
DEBUG_ENABLED = False
CONFIG_PATH = 'config/config_tpu_train_stage1.json'
...
def main():
    ...
    save_config_checkpoint(training_args.checkpoints_dir, json_path=CONFIG_PATH)
    ...
    logger.info('Stage 1 duration: {}'.format(stage1_end_time - stage1_start_time))
